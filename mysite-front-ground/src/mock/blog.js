...
Mock.mock(/^\/api\/blog(\?.+)?$/, 'get', function(options) {
  ...
  const data = Mock.mock({
    ...
    [`rows|${query.limit}`]: [{
      ...
      'thumb|1': ["@image( '300x250', '@color', '#fff', 'TestImage' )", null],
...
Mock.mock(/^\/api\/blog\/[^/]+/, 'get', {
  ...
  data: {
    ...
    'scanNumber|100-500': 0,
    'commentNumber|10-50': 0,
    ...
    'thumb|1': ["@image( '300x250', '#000', '#fff', 'TestImage' )",
      "@image( '300x250', '#000', '#00f', 'TestImage' )",
      "@image( '300x250', '#000', '#0f0', 'TestImage' )",
      "@image( '300x250', '#000', '#f00', 'TestImage' )"],
  }
});
