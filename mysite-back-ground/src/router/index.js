...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        meta: { title: '控制台', icon: 'el-icon-cpu', auth: true }
      }
    ]
  },
  // {
  ...
  // 文章管理
  {
    ...
    children: [
      ...
      },
      {
        path: 'types',
        name: 'Types',
        component: () => import('@/views/article/articleTypes/index'),
        meta: { title: '文章分类', icon: 'el-icon-reading', auth: true }
      },
      {
        path: 'add',
        name: 'Add',
  ...
  // 项目管理
  {
    ...
    children: [
      ...
      },
      {
        path: 'add',
        name: 'projectsAdd',
        component: () => import('@/views/projects/projectsAdd/index'),
  ...
  // 个人中心
  {
    path: '/selfCenter',
    component: Layout,
    redirect: '/selfCenter/index',
    children: [
      {
        path: 'index',
        name: 'SelfCenter',
        component: () => import('@/views/selfCenter/index'),
